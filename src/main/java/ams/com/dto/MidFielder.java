...
public class MidFielder {
	...
	public MidFielder(String name, String chanceOfPlaying, String form, Integer pointsPerGame, Integer fixture,
	...
	public String toString() {
		return "MidFielder [name=" + name + ", chanceOfPlaying=" + chanceOfPlaying + ", form=" + form
